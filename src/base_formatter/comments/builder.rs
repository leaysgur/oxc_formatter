...
use crate::base_formatter::source_map::{DeletedRangeEntry, DeletedRanges};
use crate::base_formatter::{TextRange, TextSize};
...
mod tests {
    ...
    use crate::base_formatter::comments::{
        CommentKind, CommentPlacement, CommentStyle, CommentTextPosition, CommentsMap,
        DecoratedComment, SourceComment,
    };
    use crate::base_formatter::{TextSize, TransformSourceMap, TransformSourceMapBuilder};
