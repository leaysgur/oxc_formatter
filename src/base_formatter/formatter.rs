...
impl<'buf, Context> Formatter<'buf, Context> {
    ...
    /// Specialized version of [crate::base_formatter::Formatter::join_with] for joining SyntaxNodes separated by a space, soft
    ...
    /// a [crate::base_formatter::builders::soft_line_break_or_space] or [crate::base_formatter::builders::empty_line] depending on how many line breaks were
    ...
    /// Specialized version of [crate::base_formatter::Formatter::join_with] for joining SyntaxNodes separated by one or more
    /// line breaks depending on the input file.
    ///
    /// This function inspects the input source and separates consecutive elements with either
    /// a [crate::base_formatter::builders::hard_line_break] or [crate::base_formatter::builders::empty_line] depending on how many line breaks were separating the
    ...
    /// Specialized version of [crate::base_formatter::Formatter::join_with] for joining SyntaxNodes separated by a simple space.
    ///
    /// This function *disregards* the input source and always separates consecutive elements with a plain
    /// [crate::base_formatter::builders::space], forcing a flat layout regardless of any line breaks or spaces were separating
    ...
    /// Concatenates a list of [crate::base_formatter::Format] objects with spaces and line breaks to fit
