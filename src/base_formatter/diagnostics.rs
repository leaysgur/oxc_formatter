...
pub enum FormatError {
    ...
    /// choice by an enclosing [crate::base_formatter::Format] resulted in a poor layout for a child [crate::base_formatter::Format].
    ///
    /// It's up to an enclosing [crate::base_formatter::Format] to handle the error and pick another layout.
    /// This error should not be raised if there's no outer [crate::base_formatter::Format] handling the poor layout error,
