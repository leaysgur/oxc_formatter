...
///
/// This macro produces a value of type [crate::base_formatter::Arguments]. This value can be passed to
/// the macros within [crate]. All other formatting macros ([`format!`](crate::base_formatter::format!),
/// [`write!`](crate::base_formatter::write!)) are proxied through this one. This macro avoids heap allocations.
///
...
/// ```
///
/// [`Format`]: crate::base_formatter::Format
/// [`Arguments`]: crate::base_formatter::Arguments
#[macro_export]
macro_rules! format_args {
    ($($value:expr),+ $(,)?) => {
        $crate::base_formatter::Arguments::new(&[
            $(
                $crate::base_formatter::Argument::new(&$value)
            ),+
        ])
    }
}
...
/// generally this comes from an implementation of the [crate::base_formatter::Buffer] trait.
///
/// # Examples
///
/// ```rust
...
macro_rules! dbg_write {
    ($dst:expr, [$($arg:expr),+ $(,)?]) => {{
        use $crate::base_formatter::BufferExtensions;
        let mut count = 0;
        ...
        let result = inspect.write_fmt($crate::base_formatter::format_args!($($arg),+));
        result
    }}
}
...
///
/// The first argument `format!` receives is the [crate::base_formatter::FormatContext] that specify how elements must be formatted.
/// Additional parameters passed get formatted by using their [crate::base_formatter::Format] implementation.
///
///
/// ## Examples
///
...
macro_rules! format {
    ($context:expr, [$($arg:expr),+ $(,)?]) => {{
        ($crate::base_formatter::format($context, $crate::format_args!($($arg),+)))
    }}
}
...
///
/// [crate::base_formatter::BestFitting] acts as a "break" boundary, meaning that it is considered to fit
///
///
/// [`Flat`]: crate::base_formatter::format_element::PrintMode::Flat
/// [`Expanded`]: crate::base_formatter::format_element::PrintMode::Expanded
/// [`MostExpanded`]: crate::base_formatter::format_element::BestFittingElement::most_expanded
#[macro_export]
...
mod tests {
    ...
    use crate::base_formatter::{
        Buffer, Format, FormatElement, FormatResult, FormatState, Formatted, SimpleFormatContext,
