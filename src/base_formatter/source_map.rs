use crate::base_formatter::{Printed, SourceMarker, TextRange};
...
impl TransformSourceMap {
    ...
    /// back to the locations of the tree. However, the source positions stored in [crate::base_formatter::FormatElement::DynamicText]
    /// and [crate::base_formatter::FormatElement::LocatedTokenText] are relative to the transformed tree
    /// and not the original tree passed to [crate::base_formatter::format_node].
    ///
...
#[cfg(test)]
mod tests {
    use crate::base_formatter::source_map::DeletedRangeEntry;
    use crate::base_formatter::{TextRange, TextSize, TransformSourceMapBuilder};
