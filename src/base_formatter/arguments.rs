...
use crate::base_formatter::FormatResult;
use std::ffi::c_void;
use std::marker::PhantomData;

/// Mono-morphed type to format an object. Used by the [crate::base_formatter::format!], [crate::base_formatter::format_args!], and
/// [crate::base_formatter::write!] macros.
///
...
mod tests {
    ...
    use crate::base_formatter::{FormatState, VecBuffer};
