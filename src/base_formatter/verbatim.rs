use crate::base_formatter::format_element::tag::VerbatimKind;
use crate::base_formatter::prelude::*;
use crate::base_formatter::trivia::{FormatLeadingComments, FormatTrailingComments};
use crate::base_formatter::{CstFormatContext, FormatWithRule};
use crate::write;
